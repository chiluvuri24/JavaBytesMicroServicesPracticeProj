...
public class AccountsController {
    ...
    public ResponseEntity<String> buildVersion() throws TimeoutException {
        logger.info("buildVersion() method invoked ");
        //throw new TimeoutException();
        return ResponseEntity.status(HttpStatus.OK).body(buildVersion);
    }

    public ResponseEntity<String> buildVersionFallback(Throwable throwable){
        logger.info("buildVersionFallback() method invoked ");
        return ResponseEntity.status(HttpStatus.OK).body("0.2");
    }
    ...
    public ResponseEntity<String> javaVersionFallback(Throwable throwable){
        return ResponseEntity.status(HttpStatus.OK).body("JV 17");
    }
