...
import com.eazybytes.loans.dto.ContactDetailsInfoDTO;
...
public class LoansController {
    ...
    @Autowired
    private LoansController(ILoansService iLoansService){
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("eazybank-corelation-id") String corelationId,@RequestParam
                                                               @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                               String mobileNumber) {
